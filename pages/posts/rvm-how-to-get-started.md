...
<pre class="">ruby 2.6.3p62 (2019-04-16 revision 67580) [x86_64-darwin18]</pre>
</br>
...
<pre class="code" title="triple click to select command">gem install pry</pre>
If installation of the <a href="http://pryrepl.org/">pry</a> gem is successful, the last line of the output will be what follows:
<pre class="code" title="triple click to select command">Done installing documentation for method_source, coderay, pry after 3 seconds
...
<pre class="code" title="triple click to select command">pry
</pre>
...
<pre class="code" title="triple click to select command">rvm install 2.5</pre>
